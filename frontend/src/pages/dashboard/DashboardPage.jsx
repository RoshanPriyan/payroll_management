...
function getAttendanceBarHeight(
  value,
  maxValue,
) {
  ...
  return (
    ...
    >
      ...
      <g transform="translate(62,48)">
        <path
          d="M32 55c-12-20-7-42 11-56 12 25 7 44-11 56Z"
          fill="#93C5FD"
          opacity=".8"
        />

        <path
          d="M47 58c-1-23 12-40 34-48 0 27-12 42-34 48Z"
          fill="#60A5FA"
          opacity=".72"
        />

        <path
          d="M52 71c5-21 21-32 43-33-8 24-23 35-43 33Z"
          fill="#BFDBFE"
        />
      ...
      <g transform="translate(276,46)">
        ...
        <rect
          ...
          rx="7"
          fill="#fff"
          filter="drop-shadow(0 12px 18px rgba(37,99,235,.12))"
        />
          ...
          {rows.map((row) => (
            <li key={row[1]}>
              ...
              <Box className="paymentRight">
                ...
                <span className="dashBadge badgeMode">
                  {row[5]}
                </span>
              </Box>
            </li>
...
export default function DashboardPage() {
  ...
  const maxAttendanceCount =
    Math.max(
      0,
      ...weeklyAttendance.flatMap(
        (item) => [
          item.present,
          item.absent,
          item.halfDay,
      ...
      <Card className="dashCard welcomeCard">
        <CardContent>
          ...
          <Box className="welcomeText">
            ...
            <Typography className="welcomeDate">
              <CalendarMonth />
              {dashboardDateLabel}
            </Typography>
            ...
            <Box className="welcomeStats">
              ...
              {heroStats.map(
                (stat) => (
                  <Box
                    className="welcomeStat"
                    key={stat.label}
                  >
                    <span
                      className={`welcomeStatIcon ${stat.tone}`}
                    >
                      {stat.icon || (
                        <i />
                      )}
                ...
                (item) => (
                  ...
                  >
                    ...
                    <Box className="barPair">
                      ...
                      {/* PRESENT BAR */}
                      <Box className="attendanceBarWrapper">
                        <span
                          className="presentBar attendanceBar"
                          style={{
                            height:
                              getAttendanceBarHeight(
                                item.present,
                                maxAttendanceCount,
                              ),
                          }}
                      ...
                      <Box className="attendanceBarWrapper">
                        <span
                          className="absentBar attendanceBar"
                          style={{
                            height:
                              getAttendanceBarHeight(
                                item.absent,
                      ...
                      <Box className="attendanceBarWrapper">
                        <span
                          className="halfDayBar attendanceBar"
                          style={{
                            height:
                              getAttendanceBarHeight(
                                item.halfDay,
                    ...
                    {/* DATE */}
                    <Box className="dayLabel">

                      <Typography className="dayName">
                        {item.day}
                      </Typography>

                      <Typography className="dayDate">
                        {item.date}
                      </Typography>
